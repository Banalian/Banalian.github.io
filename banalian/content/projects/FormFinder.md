...
Dans le cadre d'un cours de jeu sérieux, j'ai eu l'occasion de réaliser ce jeu avec l'aide d'une équipe de 6 personnes, en moins de deux mois. Le jeu a été réalisé avec Unity, en C#.
...
Sur ce projet, j'ai eu l'occasion de travailler sur plusieurs aspects techniques de la partie 2D du jeu comme la représentation des données des formes, l'intégration des systèmes, le système de machines, et le système de niveau. Je vais ici vous présenter les deux derniers aspects :
...
Ce système fonctionne en essayant un maximum de réduire la duplication de code, et de faciliter un maximum la création de machines en tant que game designer. Pour atteindre ce but, le logique des machines ont été séparées en deux parties :
...
#### Edition / Jeu
 ...
 Afin de pouvoir progresser dans le jeu, on observe deux parties distincte dans la résolution d'un niveau :
